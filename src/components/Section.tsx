...
const Section = ({ title = '', id, children }: SectionProps) => {
  return (
    <section id={id} className="tw-relative tw-min-h-screen tw-flex tw-flex-col tw-scroll-m-16">
      <h1></h1>
      {title && (
      ...
      <div className="tw-pb-16 tw-px-5 tw-flex-1 tw-flex tw-items-center tw-justify-center">{children}</div>
    </section>
  );
}
